...
const OfflineDemo = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-r from-gray-50 via-white to-gray-50">
      <Navbar />
      <div className="max-w-7xl mx-auto px-6 py-12">
        ...
        <div className="bg-gray-100 p-8 rounded-lg mb-12">
          ...
          <p className="text-lg text-center text-gray-700 mb-4">
            Our support team is here to help you with any queries. Reach out to
            us anytime, and we'll ensure you're fully supported.
          </p>
